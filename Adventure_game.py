...
if antwoord.lower().strip() == "ja":
    ...
    if antwoord.lower().strip() == "ja":
        ...
        if antwoord.lower().strip() == "bos":
            print()
            antwoord = input("Goede keuze, je gaat het bos en komt een grot tegen. Ga je de grot in? (ja/nee) ")
            print()
            if antwoord.lower().strip() == "ja":
                ...
                if antwoord.lower().strip() == "ja":
                    ...
                    print("Correcte keuze, je gaat verder het bos in en vindt een verlaten huis.")
                    ...
                    if antwoord.lower().strip() == "ja":
                        ...
                        if antwoord.lower().strip() == "ja":
                            print()
                            print("Goede keuze, je gaat het luik naar beneden en komt terecht in een ruimte waarin allemaal moderne spullen staan")
                            ...
                            if antwoord.lower().strip() == "ja":
                                print("Uitstekende keuze, het lijkt erop dat de radio het nog doet en je besluit contact te zoeken met iemand via de radio.")
                                print()
